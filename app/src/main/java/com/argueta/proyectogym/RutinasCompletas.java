...
public class RutinasCompletas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rutinas_completas);

        mAuth= FirebaseAuth.getInstance();
        recyclerView=findViewById(R.id.rutinasCompletasList);
        String uid=mAuth.getUid();
        System.out.println(uid);
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("Entrenamiento");
